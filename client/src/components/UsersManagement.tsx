...
export function UsersManagement() {
  ...
  return (
    <div>
      ...
      {reveal && (
        <>
          <div className="fixed inset-0 z-30 bg-night/25 animate-fade-in" />
          <div className="fixed inset-0 z-40 flex items-center justify-center px-4">
            <div className="w-full max-w-sm animate-rise-in rounded-2xl border border-ink-100 bg-surface p-6 shadow-panel">
              ...
              <button
                ...
                className="w-full rounded-lg bg-night py-2.5 text-sm font-medium text-white transition hover:bg-brand-600"
              >
                Rendben, elmentettem
              </button>
            </div>
